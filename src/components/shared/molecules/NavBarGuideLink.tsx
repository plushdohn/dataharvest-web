...
export default function NavBarGuideLink() {
  return (
    <NavBarGenericLinkContainer href="/guide">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        className="fill-current text-gray-600 w-6 h-6 mb-2"
      >
      ...
      <span className="text-gray-500 text-xs">Guide</span>
