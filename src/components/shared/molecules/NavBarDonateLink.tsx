export default function NavBarDonateLink() {
  return (
    <a
      className="mt-2 w-16 hover:bg-gray-800 py-2 flex flex-col items-center text-gray-500 cursor-pointer"
      href="https://ko-fi.com/dataharvest"
    >
      <svg
